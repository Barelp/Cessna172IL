    ...
    return (
        <div className="min-h-screen flex flex-col bg-aviation-gray dark:bg-gray-900 transition-colors duration-300">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-48 md:h-56 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <nav className="hidden md:flex gap-2">
                            ...
                            <a href="https://github.com/Barelp/Cessna172IL/issues/new" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-md text-sm font-semibold backdrop-blur-md border border-white/30 flex items-center gap-2 transition-all bg-white/20 text-white hover:bg-white/30">
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex justify-around pb-safe z-[100] transition-colors">
                ...
                <a href="https://github.com/Barelp/Cessna172IL/issues/new" target="_blank" rel="noopener noreferrer" className="flex-1 flex flex-col items-center justify-center py-3 text-gray-500">
