...
export default function StationDiagramNew({
    emptyWeight = 0,
    pilotWeight = 0,
    frontPaxWeight = 0,
    rearPax1Weight = 0,
    ...
    return (
        <div className="w-full relative bg-white dark:bg-gray-800 rounded-xl overflow-hidden transition-colors duration-300 aspect-[3/4] md:aspect-[4/3]">
            ...
            <div className="absolute inset-0">
                ...
                {/* Fuel Left */}
                <div className="absolute top-[33%] md:top-[25%] left-[10%] md:left-[20%]">
                    <div className="bg-emerald-100/20 dark:bg-emerald-900/20 backdrop-blur-sm border border-emerald-600/50 dark:border-emerald-500/50 rounded px-1.5 py-0.5 shadow-sm text-center min-w-[50px] transition-colors">
                ...
                {/* Fuel Right */}
                <div className="absolute top-[33%] md:top-[25%] right-[10%] md:right-[20%]">
                    <div className="bg-emerald-100/20 dark:bg-emerald-900/20 backdrop-blur-sm border border-emerald-600/50 dark:border-emerald-500/50 rounded px-1.5 py-0.5 shadow-sm text-center min-w-[50px] transition-colors">
                ...
                {/* Front Passengers */}
                <div className="absolute top-[33%] md:top-[17%] left-[50%] -translate-x-1/2">
                    <div className="bg-sky-100/20 dark:bg-sky-900/30 backdrop-blur-sm border border-sky-600/50 dark:border-sky-500/50 rounded px-2 py-0.5 shadow-md text-center min-w-[85px] transition-colors">
                ...
                {/* Rear Passengers */}
                <div className="absolute top-[50%] md:top-[48%] left-[50%] -translate-x-1/2">
                    <div className="bg-purple-100/20 dark:bg-purple-900/30 backdrop-blur-sm border border-purple-600/50 dark:border-purple-500/50 rounded px-2 py-0.5 shadow-md text-center min-w-[85px] transform hover:scale-105 transition cursor-default">
                ...
                {/* Baggage 1 */}
                <div className="absolute top-[64%] md:top-[62%] left-[50%] -translate-x-1/2">
                    <div className="bg-pink-100/20 dark:bg-pink-900/30 backdrop-blur-sm border border-pink-500/50 rounded px-2.5 py-0.5 shadow-sm text-center min-w-[80px] transition-colors">
                ...
                {/* Baggage 2 */}
                <div className="absolute top-[78%] md:top-[72%] left-[50%] -translate-x-1/2">
                    <div className="bg-yellow-100/20 dark:bg-yellow-900/30 backdrop-blur-sm border border-yellow-500/50 rounded px-2.5 py-0.5 shadow-sm text-center min-w-[80px] transition-colors">
                ...
                {/* BEW / Empty Weight */}
                <div className="absolute top-[2%] md:bottom-[4%] left-[50%] -translate-x-1/2">
                    <div className="bg-gray-100/20 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-400/50 rounded px-3 py-1 shadow-sm text-center min-w-[100px] transition-colors">
