...
export default function Config() {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 transition-colors duration-300">
            {/* Header Section without outer box */}
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                <Settings className="h-6 w-6 text-aviation-blue dark:text-aviation-blue" />
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{t('config.title')}</h1>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Preset Selector */}
                <div className="md:col-span-2 bg-[#f4f7fb] dark:bg-blue-900/10 border border-blue-200 dark:border-blue-900/50 rounded-lg p-4 transition-colors">
                    <div className="flex items-center gap-2 mb-3">
                        <Plane className="h-5 w-5 text-aviation-blue dark:text-blue-400" />
                        <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wide">{t('config.quickLoad')}</h3>
                    </div>
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative px-4 py-3 rounded-md transition-all text-left group ${isSelected
                                        ...
                                        : 'bg-white dark:bg-[#1a202c] border border-blue-300 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-gray-800 hover:border-aviation-blue dark:hover:border-blue-500'
                                        }`}
                                >
                                    {isSelected && (
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`relative px-4 py-3 rounded-md transition-all text-left group cursor-pointer ${isSelected
                                                ...
                                                : 'bg-white dark:bg-[#1a202c] border border-green-400 dark:border-green-700 hover:bg-green-50 dark:hover:bg-gray-800 hover:border-green-600 dark:hover:border-green-500'
                                                }`}
                                        >
                                            {isSelected && (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm px-3 py-2 transition-colors ${isNewMode
                                    ? 'bg-white dark:bg-[#1a202c] focus:border-green-500 focus:ring-green-500 dark:text-gray-100'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1a202c] shadow-sm focus:border-aviation-blue focus:ring-aviation-blue dark:text-gray-100 px-3 py-2 transition-colors"
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1a202c] shadow-sm focus:border-aviation-blue focus:ring-aviation-blue dark:text-white px-3 py-2 text-sm transition-colors"
                                step="0.1"
                            />
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1a202c] shadow-sm focus:border-aviation-blue focus:ring-aviation-blue dark:text-white px-3 py-2 transition-colors"
                                step="0.1"
                            />
                        </div>
                        <div>
